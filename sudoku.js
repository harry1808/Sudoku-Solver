...
var SudokuSolver = function(testable){
  ...
  if (testable){
    //These methods will be exposed publically when testing is on,.
    solver = {
      solve: solve,
      ...
      getBox: getBox,
      collectionIsValid: collectionIsValid,toString: toString
    };
  } else{
    //Those will be the only public methods when testing  is off.
    solver = {solve:solve,
      solveAndPrint: solveAndPrint
    };
  }
